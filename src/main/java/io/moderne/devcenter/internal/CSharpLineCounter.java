...
/**
 * Counts lines in a C# LST in-process. The C# printer runs out-of-process over RPC, so {@code printAll()}
 * is expensive; walking the tree here avoids that round trip entirely.
 */
final class CSharpLineCounter extends CSharpVisitor<Counter> {
