...
/**
 * Counts lines in a Python LST in-process. The Python printer runs out-of-process over RPC, so
 * {@code printAll()} is expensive; walking the tree here avoids that round trip entirely.
 */
final class PythonLineCounter extends PythonVisitor<Counter> {
